...
extern "C" void next()
{
	...
	//显示加载日志
	Kernel::Instance().GetLogManager().Load_LogSuperBlock(); //new add 
	Diagnose::Write("Unix V6++ LogSystem Loading......OK\n");

	Diagnose::Write("Unix V6++ Log Recover Start......OK\n");
	Kernel::Instance().GetLogManager().Recover();// 恢复
