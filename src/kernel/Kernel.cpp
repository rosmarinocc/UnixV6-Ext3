...
void Kernel::InitLogManager()
{
	this->m_LogManager = &g_LogManager;
	Diagnose::Write("Initialize LogManager...");
	this->GetLogManager().Initialize();
	Diagnose::Write("OK.\n");
}

LogManager& Kernel::GetLogManager()
{
	// Diagnose::Write("Kernel::GetLogManager() OK\n");
